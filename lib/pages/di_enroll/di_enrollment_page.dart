...
class DiEnrollment extends StatefulWidget {
  ...
  const DiEnrollment({Key? key, this.packageCodeJson}) : super(key: key);

  @override
  DiEnrollmentState createState() => DiEnrollmentState();
}

class DiEnrollmentState extends State<DiEnrollment> {
