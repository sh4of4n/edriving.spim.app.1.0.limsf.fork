...
class GetTrainerInfoResponse{
  List<Trainer>? trainerInfo;

  GetTrainerInfoResponse({this.trainerInfo});

  GetTrainerInfoResponse.fromJson(Map<String, dynamic> json){
    if (json['Trainer'] != null) {
      trainerInfo = <Trainer>[];
      json['Trainer'].forEach((v) {
        trainerInfo!.add(Trainer.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson(){
    final Map<String, dynamic> data = <String, dynamic>{};
    if (trainerInfo != null) {
      data['Trainer'] = trainerInfo!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
