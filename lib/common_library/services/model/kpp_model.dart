...
class GetTheoryQuestionByPaperResponse {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (theoryQuestion != null) {
      data['TheoryQuestion'] = theoryQuestion!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class TheoryQuestion {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['question_option_1_photo_filename'] = questionOption1PhotoFilename;
    data['question_option_1_voice_filename'] = questionOption1VoiceFilename;
    data['question_option_2'] = questionOption2;
    data['question_option_2_photo'] = questionOption2Photo;
    data['question_option_2_photo_filename'] = questionOption2PhotoFilename;
    data['question_option_2_voice_filename'] = questionOption2VoiceFilename;
    data['question_option_3'] = questionOption3;
    data['question_option_3_photo'] = questionOption3Photo;
    data['question_option_3_photo_filename'] = questionOption3PhotoFilename;
    data['question_option_3_voice_filename'] = questionOption3VoiceFilename;
    data['question_option_4'] = questionOption4;
    data['question_option_4_photo'] = questionOption4Photo;
    data['question_option_4_photo_filename'] = questionOption4PhotoFilename;
    data['question_option_4_voice_filename'] = questionOption4VoiceFilename;
    data['question_option_5'] = questionOption5;
    data['question_option_5_photo'] = questionOption5Photo;
    data['question_option_5_photo_filename'] = questionOption5PhotoFilename;
    data['question_option_5_voice_filename'] = questionOption5VoiceFilename;
