...
class GetUserMeetingAccountResponse {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (zmMeetingUser != null) {
      data['ZmMeetingUser'] = zmMeetingUser!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class GetUserRegisteredDIResponse {
  ...
  GetUserRegisteredDIResponse.fromJson(Map<String, dynamic> json) {
    if (json['ArmasterProfile'] != null) {
      ...
      debugPrint("Zoom User length${zoomUser!.length}");
    }
  }
...
class ParticipantsDB {
  ...
  factory ParticipantsDB.fromMap(Map<String, dynamic> json) => ParticipantsDB(
        id: json["id"],
        name: json["name"],
