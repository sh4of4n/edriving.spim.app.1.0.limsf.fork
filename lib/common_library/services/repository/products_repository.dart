...
class ProductsRepo {
  ...
  Future<Response> getUomByPaging({
    ...
    String path =
        'wsCodeCrypt=TBSERPWS&caUid=$caUid&caPwd=$caPwdEncode&uom=${uom ?? ''}&publish=$publish&isVerify=$isVerify&startIndex=$startIndex&noOfRecords=$noOfRecords';
  ...
  Future<Response> getCategoryByPaging({
    ...
    String path =
        'wsCodeCrypt=TBSERPWS&caUid=$caUid&caPwd=$caPwdEncode&stkCat=${stkCat ?? ''}&publish=$publish&isVerify=$isVerify&startIndex=$startIndex&noOfRecords=$noOfRecords';
  ...
  Future<Response> getGroupByPaging({
    ...
    String path =
        'wsCodeCrypt=TBSERPWS&caUid=$caUid&caPwd=$caPwdEncode&stkCat=${stkGrp ?? ''}&publish=$publish&isVerify=$isVerify&startIndex=$startIndex&noOfRecords=$noOfRecords';
  ...
  Future<Response> getStockPictureList({
    ...
    String path =
        'wsCodeCrypt=TBSERPWS&caUid=$caUid&caPwd=$caPwdEncode&stkCode=${Uri.encodeComponent(stkCode)}&startIndex=$startIndex&noOfRecords=$noOfRecords';
