...
class EmergencyRepo {
  ...
  Future<Response> getPandemicTrack({
    ...
    String path =
        'wsCodeCrypt=${appConfig.wsCodeCrypt}&caUid=$caUid&caPwd=$caPwd&diCode=$diCode&phone=$phone&dateFromString=$dateFromString&dateToString=$dateToString&startIndex=$startIndex&noOfRecords=$noOfRecords&merchantNo=$merchantNo&userId=$userId&appCode=${appConfig.appCode}&appId=${appConfig.appId}&deviceId=$deviceId';
  ...
  Future<Response> getPandemicPDFReport({
    ...
    String path =
        'wsCodeCrypt=${appConfig.wsCodeCrypt}&caUid=$caUid&caPwd=$caPwd&diCode=$diCode&phone=$phone&dateFromString=$dateFromString&dateToString=$dateToString&merchantNo=$merchantNo&userId=$userId&appCode=${appConfig.appCode}&appId=${appConfig.appId}&deviceId=$deviceId';
