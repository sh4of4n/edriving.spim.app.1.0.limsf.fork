...
class RootRouter extends $RootRouter {
  ...
  final List<AutoRoute> routes = [
    ...
    AutoRoute(
        path: '/clientAccount',
        page: ClientAccount.page /* , name: 'ClientAccount' */),
    ...
    AutoRoute(
        page: RegisterVerification.page /*, name: 'RegisterVerification' */),
    ...
    AutoRoute(
        page:
            SelectDrivingInstitute.page /* ,name: 'SelectDrivingInstitute' */),
    ...
    AutoRoute(
        page: PaymentHistoryDetail.page /* ,name: 'PaymentHistoryDetail' */),
    AutoRoute(page: RequestPickup.page /* , name: 'RequestPickup' */),
    AutoRoute(page: RegisteredCourse.page /* ,name: 'RegisteredCourse' */),
    AutoRoute(
        page:
            RegisteredCourseDetail.page /* ,name: 'RegisteredCourseDetail' */),
    ...
    AutoRoute(
        page: EnrolmentInfoDetail.page /* ,name: 'EnrolmentInfoDetail' */),
